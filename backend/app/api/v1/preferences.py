...
def _to_preference_response(pref) -> PreferenceResponse:
    ...
    return PreferenceResponse(
        ...
        ai_base_url=getattr(pref, "ai_base_url", None) or settings.OMNIROUTE_BASE_URL,
        ai_fallback_provider=getattr(pref, "ai_fallback_provider", None),
        ai_fallback_model=getattr(pref, "ai_fallback_model", None),
        has_custom_api_key=bool((getattr(pref, "ai_api_key", None) and pref.ai_api_key.strip()) or settings.OMNIROUTE_API_KEY),
